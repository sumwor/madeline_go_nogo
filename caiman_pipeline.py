...
"""
root_input_folder = r'Z:\HongliWang\Madeline\raw_imaging'
root_output_folder = r'Z:\HongliWang\Madeline\processed_data'
input_sub = 'ADT001'
...
for folder in dataFolder:
    output_folder = os.path.join(root_output_folder, input_sub, folder)
